...
extension CSSAtRuleTypes.Media {
    ...
    package static let tablet = Self(rawValue: "@media only screen and (min-width: 768px) and (max-width: 1024px)")
    ...
    package static let retina = Self(rawValue: "@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi)")
    package static let smallMobile = Self(rawValue: "@media only screen and (max-width: 320px)")
    package static let largeMobile = Self(rawValue: "@media only screen and (min-width: 321px) and (max-width: 767px)")
