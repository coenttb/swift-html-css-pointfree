    ...
    func asideWithinArticleRendersCorrectly() {
        assertInlineSnapshot(
            of: Article {
                ...
                Paragraph {
                    HTMLText("From simple HTML pages to complex web applications, the field has grown tremendously.")
                }
            },
            as: .html
        ) {
                ...
                Main() {
                    Article() {
                        ...
                        Section {
                            ...
                            Paragraph {
                                HTMLText("HTML5 introduced many new semantic elements that provide meaning to web content.")
                            }
                        }
                    }
                    Aside() {
