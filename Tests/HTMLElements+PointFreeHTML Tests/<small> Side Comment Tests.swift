    ...
    func smallForDisclaimersRendersCorrectly() {
        assertInlineSnapshot(
            of: ContentDivision {
                ...
                Small {
                    HTMLText("*Offer valid until December 31, 2024. Terms and conditions apply. Cannot be combined with other offers.")
                }
            },
            as: .html
        ) {
                ...
                Main {
                    Article {
                        ...
                        Section {
                            ...
                            Paragraph {
                                HTMLText("By accessing and using this website, you accept and agree to be bound by the terms and provision of this agreement.")
                            }
                        }
                        Footer {
                            Small {
                                HTMLText("This document is legally binding. Please read carefully before using our services.")
                            }
                        }
                    }
                }
