...
struct DefinitionTests {
    ...
    func dfnWithComplexDefinitionRendersCorrectly() {
        assertInlineSnapshot(
            of: Definition(
                title: "Application Programming Interface - a set of protocols and tools for building software applications"
            ) {
                Abbreviation {
                    HTMLText("API")
                }
    ...
    func dfnInTechnicalDocumentationRendersCorrectly() {
        assertInlineSnapshot(
            of: Paragraph {
                ...
                HTMLText(" allows scripts to dynamically access and update the content, structure, and style of documents.")
            },
            as: .html
        ) {
            """
    ...
    func dfnWithIdForCrossReferencingRendersCorrectly() {
        assertInlineSnapshot(
            of: Definition(
                title: "Cascading Style Sheets - a style sheet language used for describing the presentation of a document"
            ) {
                HTMLText("CSS")
            },
            as: .html
            ...
            of: HTMLDocument {
                Article {
                    ...
                    DescriptionList {
                        DescriptionTerm {
                            Definition(
                                title: "JavaScript - a high-level, interpreted programming language"
                            ) {
                                HTMLText("JavaScript")
                            }
                        }
                        DescriptionDetails {
                            HTMLText("A versatile programming language primarily used to create interactive effects within web browsers.")
                        }
                        DescriptionTerm {
                            Definition(
                                title: "Responsive Web Design - an approach that makes web pages render well on various devices"
                            ) {
                                Abbreviation {
                                    HTMLText("RWD")
                                }
                        ...
                        DescriptionDetails {
                            HTMLText("A design approach aimed at crafting sites to provide optimal viewing experience across different devices.")
                        }
                    }
                    Paragraph {
                        HTMLText("Understanding ")
                        Definition(
                            title: "Semantic HTML - HTML markup that reinforces the semantics or meaning of the information"
                        ) {
                            HTMLText("semantic HTML")
                        }
                        HTMLText(" is crucial for creating accessible and SEO-friendly web pages.")
                    }
                }
            },
            as: .html
